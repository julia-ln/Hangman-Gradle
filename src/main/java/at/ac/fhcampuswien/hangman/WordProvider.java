...
public class WordProvider {
    ...
    public WordProvider() {
        ...
        wordCategories.put("Countries", Arrays.asList("Austria","Bhutan","Mozambique","Kyrgyzstan","Laos","Denmark","Somalia","Paraguay","Finland","Thailand","Norway","Kazakhstan","Netherlands","Myanmar","Yemen","Ireland","Iceland","Japan","Pakistan","Croatia","Mexico","Poland","Vietnam","Switzerland","Hungary","Uzbekistan","Belgium","Australia"));
